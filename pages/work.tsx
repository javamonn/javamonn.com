...
const projectItems = [
  ...
  {
    title: "trashed",
    href: "https://github.com/javamonn/trashed",
    description:
...
const Resume = () => (
  <>
    <Head> <title>Work ■ javamonn</title>
